...
print("""texto é uma ocorrência linguística, escrita ou falada, 
que possui unidade sociocomunicativa, semântica e formal. Ele pode ser verbal, 
utilizando palavras, ou não-verbal, utilizando cores, texturas, gestos e sons""") 
